    ...
    return (
        <div className="flex min-h-screen flex-col bg-gray-50">
            ...
            <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-6">
                ...
                <div className="flex items-center gap-3">
                    {canLogin && (
                        <Link
                            href={route('login')}
                            className="rounded-md px-3 py-2 text-sm font-medium text-gray-600 transition hover:text-gray-900"
                        >
                            Log in
                        </Link>
                    )}
            ...
            <main className="flex flex-1 flex-col items-center justify-center px-6 py-16 text-center">
                <span className="mb-6 rounded-full bg-primary-50 px-3 py-1 text-xs font-semibold text-primary-700">
                ...
                <p className="mt-4 max-w-xl text-base text-gray-500">
                    ...
                    Flexmania keeps your team organized and on schedule.
                </p>
                ...
                <div className="mt-8 flex items-center gap-4">
                    ...
                    {canRegister && (
                        <Link
                            href={route('register')}
                            className="rounded-md px-5 py-2.5 text-sm font-semibold text-primary-700 ring-1 ring-inset ring-primary-600 transition hover:bg-primary-50"
                        >
                            Create account
                        </Link>
                    )}
